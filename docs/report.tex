	...
	\begin{enumerate}[resume]
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\textbf{Reasons:} 
				\begin{itemize}
					\item {The time complexity of BFS related to the maximum depth it has searched.}
					\item {Hence, a "door sill" pattern can force BFS to search lower left part rather than immediately reach the Goal, which increased the maximum depth of BFS.}
					\item {A larger lower left part increases the depth, so the upper right part should be as small as possible.}
				\end{itemize}
